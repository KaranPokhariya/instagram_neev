...
options.add_extension("/Users/rachitbansal/Downloads/instagram_neev/extension.crx")
...
username.clear()
username.send_keys("Secret.Admirer_Christ")
password.clear()
password.send_keys("BlrChrist0912@")
...
for i,account in enumerate(to_get_followers):
    ...
    try:
        ...
        time.sleep(10)
        try:
            os.system('mv /Users/rachitbansal/Downloads/{}_followers.csv /Users/rachitbansal/Downloads/instagram_neev/accounts'.format(account))
        except:
